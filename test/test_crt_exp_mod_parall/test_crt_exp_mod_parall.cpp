...
int main(){
    ...
    BN_CTX *ctx;
    BN_WORD *bn_a,*bn_e, *bn_result, *bn_exp_result;
    RSA_N *rsa_n;
    ...
    bn_exp_result=BN_WORD_new(DMAX);
...
//    crt_n.CRT_EXP_MOD(bn_a, bn_e, bn_exp_result);
...
//    cout<<"bn_exp_result"<<endl;
//    BN_WORD_print(bn_exp_result);
